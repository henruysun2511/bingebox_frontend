    ...
    return allRows.map((row, index) => {
      ...
      return {
        ...
        seats: row.seats.map((seat, sIdx) => {
          // Tính toán lại mã ghế dựa trên rowKey mới
          // Ở đây mình cần logic đếm số ghế không bị block tương tự recalcCodes
          return {
            ...seat,
            row: newKey,
            // Nếu bạn muốn code tự cập nhật lại theo đúng thứ tự A1, A2...
            // thì nên dùng một biến đếm bên ngoài map này.
          };
        })
      };
    });
